 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (iconMenu) {
                document.addEventListener("click", (function(e) {
                    ...
                    if (targetElement.closest("[data-menu-icon]")) toggleMenu(); else if (!targetElement.closest("[data-menu]") && document.documentElement.classList.contains("menu-open")) toggleMenu(false);
                }));
                if (menuDataset) {
                    ...
                    matchMedia.addEventListener("change", (function() {
                        toggleMenu(false, matchMedia);
                    }));
                }
            }
        }
        function toggleMenu(open = true, matchMedia = false) {
            ...
            if (menuIsOpen() || !open) {
                const timeOut = getTransitionDuration(document.querySelector("[data-menu]"));
        ...
        function menuKeyActions(e) {
            if (e.which === 9) focusCatch(e); else if (e.which == 27 && e.code === "Escape") toggleMenu(false);
        ...
        function customCursor(isShadowTrue = false) {
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 1e3, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                document.documentElement.classList.contains("menu-open") ? toggleMenu(false) : null;
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest("[data-form-success-btn]")) targetElement.closest("form").classList.remove("_form-send");
        }
        isWebp();
        menuInit();
        spollers();
